...
mixin _$RoadsterEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RoadsterEvent);
  }
...
extension RoadsterEventPatterns on RoadsterEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(RoadsterLoadEvent value)? load,
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(RoadsterLoadEvent value) load,
  }) {
    final _that = this;
    switch (_that) {
...
class RoadsterLoadEvent implements RoadsterEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RoadsterLoadEvent);
  }
...
mixin _$RoadsterState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RoadsterState);
  }
...
extension RoadsterStatePatterns on RoadsterState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>({
    TResult Function(RoadsterLoadingState value)? loading,
    TResult Function(RoadsterSuccessState value)? success,
    TResult Function(RoadsterErrorState value)? error,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case RoadsterSuccessState() when success != null:
        return success(_that);
      case RoadsterErrorState() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(RoadsterLoadingState value) loading,
    required TResult Function(RoadsterSuccessState value) success,
    required TResult Function(RoadsterErrorState value) error,
  }) {
    final _that = this;
    switch (_that) {
      case RoadsterLoadingState():
        return loading(_that);
      case RoadsterSuccessState():
        return success(_that);
      case RoadsterErrorState():
        return error(_that);
      case _:
        throw StateError('Unexpected subclass');
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(RoadsterResource roadster)? success,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(RoadsterResource roadster) success,
...
class RoadsterLoadingState implements RoadsterState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RoadsterLoadingState);
  }
...
class RoadsterSuccessState implements RoadsterState {
  ...
  $RoadsterSuccessStateCopyWith<RoadsterSuccessState> get copyWith =>
      _$RoadsterSuccessStateCopyWithImpl<RoadsterSuccessState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RoadsterSuccessState &&
            (identical(other.roadster, roadster) ||
...
/// @nodoc
abstract mixin class $RoadsterSuccessStateCopyWith<$Res>
    implements $RoadsterStateCopyWith<$Res> {
  factory $RoadsterSuccessStateCopyWith(RoadsterSuccessState value,
          $Res Function(RoadsterSuccessState) _then) =
      _$RoadsterSuccessStateCopyWithImpl;
  @useResult
  $Res call({RoadsterResource roadster});
}
...
class _$RoadsterSuccessStateCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  $Res call({
    Object? roadster = null,
  }) {
    return _then(RoadsterSuccessState(
      roadster: null == roadster
          ? _self.roadster
          : roadster // ignore: cast_nullable_to_non_nullable
              as RoadsterResource,
    ));
  }
}
...
class RoadsterErrorState implements RoadsterState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RoadsterErrorState);
  }
