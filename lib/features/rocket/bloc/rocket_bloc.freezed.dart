...
mixin _$RocketEvent {
  ...
  $RocketEventCopyWith<RocketEvent> get copyWith =>
      _$RocketEventCopyWithImpl<RocketEvent>(this as RocketEvent, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RocketEvent &&
...
abstract mixin class $RocketEventCopyWith<$Res> {
  factory $RocketEventCopyWith(
          RocketEvent value, $Res Function(RocketEvent) _then) =
      _$RocketEventCopyWithImpl;
  @useResult
  $Res call({String rocketId});
}

/// @nodoc
class _$RocketEventCopyWithImpl<$Res> implements $RocketEventCopyWith<$Res> {
...
extension RocketEventPatterns on RocketEvent {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(RocketLoadEvent value)? load,
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(RocketLoadEvent value) load,
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String rocketId)? load,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case RocketLoadEvent() when load != null:
        return load(_that.rocketId);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(String rocketId) load,
  }) {
    final _that = this;
    switch (_that) {
      case RocketLoadEvent():
...
class RocketLoadEvent implements RocketEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RocketLoadEventCopyWith<RocketLoadEvent> get copyWith =>
      _$RocketLoadEventCopyWithImpl<RocketLoadEvent>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RocketLoadEvent &&
            (identical(other.rocketId, rocketId) ||
                other.rocketId == rocketId));
  }
...
/// @nodoc
abstract mixin class $RocketLoadEventCopyWith<$Res>
    implements $RocketEventCopyWith<$Res> {
  factory $RocketLoadEventCopyWith(
          RocketLoadEvent value, $Res Function(RocketLoadEvent) _then) =
      _$RocketLoadEventCopyWithImpl;
  @override
  @useResult
  $Res call({String rocketId});
}
...
mixin _$RocketState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RocketState);
  }
...
extension RocketStatePatterns on RocketState {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>({
    TResult Function(RocketLoadingState value)? loading,
    TResult Function(RocketSuccessState value)? success,
    TResult Function(RocketErrorState value)? error,
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      ...
      case RocketSuccessState() when success != null:
        return success(_that);
      case RocketErrorState() when error != null:
        return error(_that);
      case _:
        return orElse();
    }
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(RocketLoadingState value) loading,
    required TResult Function(RocketSuccessState value) success,
    required TResult Function(RocketErrorState value) error,
  }) {
    final _that = this;
    switch (_that) {
      case RocketLoadingState():
        return loading(_that);
      case RocketSuccessState():
        return success(_that);
      case RocketErrorState():
        return error(_that);
      case _:
        throw StateError('Unexpected subclass');
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(RocketResource rocket)? success,
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(RocketResource rocket) success,
...
class RocketLoadingState implements RocketState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RocketLoadingState);
  }
...
class RocketSuccessState implements RocketState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RocketSuccessStateCopyWith<RocketSuccessState> get copyWith =>
      _$RocketSuccessStateCopyWithImpl<RocketSuccessState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RocketSuccessState &&
...
/// @nodoc
abstract mixin class $RocketSuccessStateCopyWith<$Res>
    implements $RocketStateCopyWith<$Res> {
  factory $RocketSuccessStateCopyWith(
          RocketSuccessState value, $Res Function(RocketSuccessState) _then) =
      _$RocketSuccessStateCopyWithImpl;
  @useResult
  $Res call({RocketResource rocket});
}
...
class RocketErrorState implements RocketState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RocketErrorState);
  }
